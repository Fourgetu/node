...
export const REST_API = {
    CORE: {
        STOP_SINGBOX: `${ROOT}/${CONTROLLERS.CORE_CONTROLLER}/${CONTROLLERS.CORE_ROUTES.STOP_SINGBOX}`,
    },
    XRAY: {
    ...
    GOST: {
        SYNC_FORWARDS: `${ROOT}/${CONTROLLERS.GOST_CONTROLLER}/${CONTROLLERS.GOST_ROUTES.SYNC_FORWARDS}`,
        HEALTH: `${ROOT}/${CONTROLLERS.GOST_CONTROLLER}/${CONTROLLERS.GOST_ROUTES.HEALTH}`,
    },
    STATS: {
